...
<div class="modal fade" id="modalAddMobil" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="z-index:99999999;">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Tambah Mobil Siluet</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="container-fluid" style="padding-left: 0px; padding-right: 0px;">
	...
	<div align="center" class="mt-4">
		<a class="btn waves-effect btn-outline-warning" href="data-mobil-siluet" role="button" style="width: 190px;">Siluet</a>
		<a href="data-mobil-liza" class="btn waves-effect btn-info" role="button" style="width: 190px;">Liza</a>
	</div>
			  ...
			  <tbody>
				      ...
				      <td class="text-center" style="width: 100px;">
				      	  <?php if($data['id_mobil'] != 5): ?>				      	
					      	 <a href="#x" role="button" class="text-warning" data-toggle="modal" data-target="#modalEditMobil" onclick="setEditParameterMobil('<?=$data['mobil']; ?>', '<?=$data['plat_nomor']; ?>', '<?=$data['penumpang']; ?>', 'tb1', '<?=$data['id_mobil']; ?>')">Edit</i></a>
							  ...
							  <a href="#x" role="button" class="text-info" data-toggle="modal" data-target="#modalReset"  onclick="setResetParameterMobil('tb1', '<?=$data['id_mobil']; ?>')">Reset</a>
							<?php endif; ?>
						</td>
					  </tr>
					  <?php } } else { ?>
